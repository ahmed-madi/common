...
LIST_FIELDS = ["name", "employee", "employee_name", "training_title", "request_date", "start_date", "end_date", "status"]
FORM_FIELDS = LIST_FIELDS + ["training_type", "training_provider", "training_duration", "is_paid", "training_price", "training_description"]
