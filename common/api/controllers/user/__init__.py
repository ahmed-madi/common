...
from frappe.core.doctype.user.user import test_password_strength, test_password_strength, _get_user_for_update_password, reset_user_data
...
def change_user_password():
    try:
        ...
        if not new_password or new_password is None:
            return build_error_response(403, "Failed to update password", "Provide password please")
