    ...
    def employee_structure_action(cls):
        ...
        def _action():
            ...
            if "company" in frappe.request.args:
                ...
                company = (
                    split_csv(company) if company and "," in company else company,
                )
    ...
    def get_routes(cls):
        return [
            Rule(
                ...
                methods=["GET"],
                endpoint=cls.employee_structure_action(),
            ),
            Rule(
                "/company/department-structure",
                methods=["GET"],
                endpoint=cls.department_structure_action(),
            ),
        ]
