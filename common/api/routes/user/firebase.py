...
def update_notifications_settings():
    return handle_call("common.api.controllers.user.firebase.update_notifications_settings")
...
firebase_rules = [
    ...
    Rule("/user/update-notification-settings", methods=["POST"], endpoint=update_notifications_settings),
]
