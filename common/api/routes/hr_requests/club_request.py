...
from common.api.controllers.hr_requests.club_request import (
    club_list,
    create_club,
    read_club,
    update_club,
...
club_request_rules = [
    ...
    Rule(
        "/hr-requests/club-request/<path:name>/", methods=["PUT"], endpoint=update_club
    ),
    Rule(
        "/hr-requests/club-request/<path:name>/",
        methods=["DELETE"],
        endpoint=delete_club,
    ),
]
